...
if (isset($_POST['save'])) {
  ...
  $update_sql = "UPDATE professors 
                 SET full_name='$name', email='$email', department='$department', university='$university', cv_path='$cv_path'
  ...
  <div class="main-content">
    ...
    <div class="profile-box">
      ...
      <form method="POST" enctype="multipart/form-data">
        ...
        <input type="text" name="university" value="<?php echo $user['university']; ?>" required>
